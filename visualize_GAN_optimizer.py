...
def main():
    study = joblib.load('./optuna/nicol/OPTIMIZER_SAVES/1000_dataset/cycleik_GAN_optimizer.pkl')

    ### optimization history ###
    opt_history_subplot = plot_optimization_history(study, target_name='Mean Absolute Error')
    opt_history_subplot.set_ylim(top=0.04, bottom=0.0)
    ...
    batch_size_to_nbr_layers_subplot = plot_contour(study, params=["batch_size", "nbr_layers"],
                                                    target_name='Mean Absolute Error', )
    ...
    noise_vector_size_to_nbr_layers_subplot = plot_contour(study, params=["noise_vector_size", "nbr_layers"], target_name='Mean Absolute Error', )
    noise_vector_size_to_nbr_layers_subplot.xaxis.label.set_fontweight('bold')
    noise_vector_size_to_nbr_layers_subplot.yaxis.label.set_fontweight('bold')
    noise_vector_size_to_nbr_layers_subplot.set_title('')
    noise_vector_size_to_nbr_layers = noise_vector_size_to_nbr_layers_subplot.figure
    plt.tight_layout()

    noise_vector_size_to_batch_size_subplot = plot_contour(study, params=["noise_vector_size", "batch_size"],
                                                           target_name='Mean Absolute Error', )
    noise_vector_size_to_batch_size_subplot.xaxis.label.set_fontweight('bold')
    noise_vector_size_to_batch_size_subplot.yaxis.label.set_fontweight('bold')
    noise_vector_size_to_batch_size_subplot.set_title('')
    noise_vector_size_to_batch_size = noise_vector_size_to_batch_size_subplot.figure
    plt.tight_layout()

    noise_vector_size_to_lr_subplot = plot_contour(study, params=["noise_vector_size", "lr"],
                                                           target_name='Mean Absolute Error', )
    noise_vector_size_to_lr_subplot.xaxis.label.set_fontweight('bold')
    noise_vector_size_to_lr_subplot.yaxis.label.set_fontweight('bold')
    noise_vector_size_to_lr_subplot.set_title('')
    noise_vector_size_to_lr = noise_vector_size_to_lr_subplot.figure
    plt.tight_layout()

    noise_vector_size_to_nbr_tanh_subplot = plot_contour(study, params=["noise_vector_size", "nbr_tanh"],
                                                   target_name='Mean Absolute Error', )
    noise_vector_size_to_nbr_tanh_subplot.xaxis.label.set_fontweight('bold')
    noise_vector_size_to_nbr_tanh_subplot.yaxis.label.set_fontweight('bold')
    noise_vector_size_to_nbr_tanh_subplot.set_title('')
    noise_vector_size_to_nbr_tanh = noise_vector_size_to_nbr_tanh_subplot.figure
    plt.tight_layout()

    ### slices ###
    slice_all_params_subplot = plot_parallel_coordinate(study, params=["lr", "batch_size", "nbr_layers", "nbr_tanh", "noise_vector_size",
                                                                       "layer0_neurons", "layer1_neurons",
                                                                       "layer2_neurons", "layer3_neurons",
                                                                       "layer6_neurons", "layer7_neurons",
                                                                       "layer8_neurons"], target_name='Mean Absolute Error')
    ...
    slice_networks_structure_subplot = plot_parallel_coordinate(study, params=["layer0_neurons", "layer1_neurons",
                                                                               "layer2_neurons", "layer3_neurons",
                                                                               "layer6_neurons", "layer7_neurons",
                                                                               "layer8_neurons"],
                                                                target_name='Mean Absolute Error')
    ...
    slice_training_params_subplot = plot_parallel_coordinate(study,
                                                             params=["lr", "batch_size", "nbr_layers", "nbr_tanh", "noise_vector_size"])
    ...
    # save images
    opt_history.savefig('./img/optimizer/GAN/opt_history.png', format='png', dpi=150)
    param_importance.savefig('./img/optimizer/GAN/param_importance.png', format='png', dpi=150)
    nbr_tanh_to_nbr_layers.savefig('./img/optimizer/GAN/nbr_tanh_to_nbr_layers.png', format='png', dpi=150)
    nbr_tanh_to_batch_size.savefig('./img/optimizer/GAN/nbr_tanh_to_batch_size.png', format='png', dpi=150)
    nbr_tanh_to_lr.savefig('./img/optimizer/GAN/nbr_tanh_to_lr.png', format='png', dpi=150)
    lr_to_batch_size.savefig('./img/optimizer/GAN/lr_to_batch_size.png', format='png', dpi=150)
    batch_size_to_nbr_layers.savefig('./img/optimizer/GAN/batch_size_to_nbr_layers.png', format='png', dpi=150)
    lr_to_nbr_layers.savefig('./img/optimizer/GAN/lr_to_nbr_layers.png', format='png', dpi=150)
    slice_all_params.savefig('./img/optimizer/GAN/slice_all_params.png', format='png', dpi=150)
    slice_networks_structure.savefig('./img/optimizer/GAN/slice_networks_structure.png', format='png', dpi=150)
    slice_training_params.savefig('./img/optimizer/GAN/slice_training_params.png', format='png', dpi=150)
    noise_vector_size_to_nbr_layers.savefig('./img/optimizer/GAN/noise_vector_size_to_nbr_layers.png', format='png', dpi=150)
    noise_vector_size_to_batch_size.savefig('./img/optimizer/GAN/noise_vector_size_to_batch_size.png', format='png', dpi=150)
    noise_vector_size_to_lr.savefig('./img/optimizer/GAN/noise_vector_size_to_lr.png', format='png', dpi=150)
    noise_vector_size_to_nbr_tanh.savefig('./img/optimizer/GAN/noise_vector_size_to_nbr_tanh.png', format='png', dpi=150)
