...
def create_single_sample():
    ...
    joint_state_msg.name = ["panda_joint1", "panda_joint2", "panda_joint3", "panda_joint4", "panda_joint5",
...
def main():
    ...
    with open('/home/jan-gerrit/repositories/cycleik_2/data/results_panda_200_4.p', 'wb') as f:
        pickle.dump(data, f)
        f.close()
