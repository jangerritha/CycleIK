...
def main():
    ...
    with tqdm(total=iterations) as pbar:
        while correct_poses < iterations and not rospy.is_shutdown():
            ...
            random_js = [random.uniform(0., 0.38615),
                         random.uniform(-1.6056, 1.6056),
                         random.uniform(-1.221, 1.518),
                         random.uniform(-3.14159, 3.14159),
                         random.uniform(-2.251, 2.251),
                         random.uniform(-3.14159, 3.14159),
                         random.uniform(-2.16, 2.16),
                         random.uniform(-3.14159, 3.14159)]
            ...
            joint_state_msg.name = ["torso_lift_joint", "shoulder_pan_joint", "shoulder_lift_joint", "upperarm_roll_joint", "elbow_flex_joint", "forearm_roll_joint", "wrist_flex_joint", "wrist_roll_joint"]
            ...
            result = None
            try:
                result = calculate_fk(h, ["wrist_roll_link"], robot_state_msg)
    ...
    with open('./data_samplers/results_fetch_200_3.p', 'wb') as f:
        pickle.dump(data, f)
        f.close()
